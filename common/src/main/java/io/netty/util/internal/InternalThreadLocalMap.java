...
//        直接调用threadLocalMap()获取threadLocalMap
        InternalThreadLocalMap threadLocalMap = thread.threadLocalMap();
//        ThreadLocalMap==null
        if (threadLocalMap == null) {
//            set创建出来的ThreadLocalMap
...
//        依靠JDK的ThreadLocal获取ThreadLocalMap
...
//            通过JDK的ThreadLocal为ThreadLocalMap赋值
...
//        通过当前FastThreadLocal的index,取出在ThreadLocalMap中对应index的元素,该元素可能是UNSET
