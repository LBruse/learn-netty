...
//        创建PooledByteBufAllocator时,默认创建2*CPU核数 HEAP_ARENA
...
//        创建PooledByteBufAllocator时,默认创建2*CPU核数 DIRECT_ARENA
...
//            headArenas数组每个元素都是PoolArena.HeapArena
...
//            directArenas数组每个元素都是PoolArena.DirectArena
...
//            内存分配时会用到headArena和directArena
//            Arena-->竞技场
            final PoolArena<byte[]> heapArena = leastUsedArena(heapArenas);
            final PoolArena<ByteBuffer> directArena = leastUsedArena(directArenas);

//            传递tinyCacheSize,smallCacheSize,normalCacheSize
